...
namespace Wallet.Data.Repositories.Interfaces
{
    ...
    {
        IEnumerable<Transactions> SP_ListTransactionByUser(string stored_procedure, int user_id);
        IEnumerable<Transactions> SP_TrasactionsByUser(string stored_procedure, int user_id);
